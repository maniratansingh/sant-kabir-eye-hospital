document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        "hero-title": { en: "Advanced Eye Care & Cataract Surgery in Basti", hi: "बस्ती में उन्नत नेत्र देखभाल और मोतियाबिंद सर्जरी" },
        "hero-description": { en: "Sant Kabir Eye Hospital delivers premium ophthalmology solutions, state-of-the-art diagnostics, and highly advanced micro-surgery. Regain your perfect vision with personalized care from our experienced specialists.", hi: "संत कबीर आई हॉस्पिटल सभी रोगियों के लिए उच्च गुणवत्ता वाली नेत्र देखभाल प्रदान करते हुए, प्रीमियम नैदानिक सेवाएं और उन्नत सूक्ष्म-सर्जरी विकल्प प्रदान करता है।" },
